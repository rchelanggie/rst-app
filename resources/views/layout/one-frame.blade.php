...
<body id="page-top">
    ...
    <div id="mySidebar" class="sidebar">
        <div class="p-3">
            <img src="{{ asset('images/LogoSidebar.png') }}" alt="Logo">
        </div>
        <div class="card">
            <a href="{{ route('home') }}" class="nav-link">
                <span class="icon"><img src="{{ asset('images/Home.png') }}" width="20px" height="20px" alt=""></span>
                <p>Home</p>
            </a>
        </div>
        ...
        <div class="card">
            <a href="{{ route('panduan') }}" class="nav-link">
                <span class="icon"><img src="{{ asset('images/Panduan.png') }}" width="20px" height="20px" alt=""></span>
                <p>Panduan</p>
            </a>
        </div>
        ...
        <div class="card">
            <a href="{{ route('informasi') }}" class="nav-link">
                <span class="icon"><img src="{{ asset('images/Tentang.png') }}" width="20px" height="20px" alt=""></span>
                <p>Tentang</p>
            </a>
        </div>
