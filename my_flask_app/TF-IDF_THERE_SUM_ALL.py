...
# Counting sentiments for each "quality"
df['Predicted_Sentiment'] = sgd_model.predict(vectorizer.transform(df['Body']))

# Assuming 'Quality' is a column in the dataset
sentiment_counts = df.groupby('Quality')['Predicted_Sentiment'].value_counts().unstack(fill_value=0)
